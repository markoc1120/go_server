...
func (cfg *apiConfig) handlerChirpsDelete(w http.ResponseWriter, r *http.Request) {
	...
	if chirp.UserID != userID {
		respondWithError(w, http.StatusForbidden, "You can't do this", err)
		return
	}

	err = cfg.db.DeleteChirp(r.Context(), chirpID)
	if err != nil {
		respondWithError(w, http.StatusInternalServerError, "Couldn't delete the chirp instance from db", err)
		return
	}
